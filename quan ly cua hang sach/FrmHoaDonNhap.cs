...
namespace quan_ly_cua_hang_sach
{
    ...
    {
        BLHoaDonNhap dbS = new BLHoaDonNhap();
        string err;
        bool Them;
        ...
        private void frmSachBanRa_Load(object sender, EventArgs e)
        {
            LoadData();
        ...
        private void btnluu_Click(object sender, EventArgs e)
        {
            if (Them)
            {
                ...
                try
                {
                    dbS.Them(this.txtMa.Text, Convert.ToDateTime(this.txtNgaynhap.Text), this.txtmaNCC.Text, ref err);
            ...
            else
            {
                try
                {
                    ...
                    dbS.CapNhat(this.txtMa.Text, Convert.ToDateTime(this.txtNgaynhap.Text), this.txtmaNCC.Text, ref err);
                    LoadData();
                    // Thông báo
