    ...
    public partial class frmTaiKhoan : Form
    {
        ...
        private void btnluu_Click(object sender, EventArgs e)
        {
            ...
            if (Them)
            {
                ...
                try
                {
                    dbS.Them(this.txtTenTK.Text, this.txtMK.Text, this.txtQuyen.Text, ref err);
            ...
            else
            {
                try
                {
                    ...
                    dbS.CapNhat(this.txtTenTK.Text, this.txtMK.Text, this.txtQuyen.Text, ref err);
                    LoadData();
                    // Thông báo
