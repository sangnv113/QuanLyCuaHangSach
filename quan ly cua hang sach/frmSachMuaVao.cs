...
{
    public partial class frmSachMuaVao : Form
    {
        BLSachMuaVao dbS = new BLSachMuaVao();
        string err;
        bool Them;
        public frmSachMuaVao()
        {
            InitializeComponent();
        }
        ...
        private void frmSachMuaVao_Load(object sender, EventArgs e)
        {
        ...
        private void grbbtn_Enter(object sender, EventArgs e)
        {
        ...
        private void btnluu_Click(object sender, EventArgs e)
        {
            if (Them)
            {
                ...
                try
                {
                    dbS.Them(this.txtMaHDmua.Text, this.txtMasach.Text, int.Parse(this.txtiatien.Text),int.Parse(this.txtsoluong.Text), ref err);
            ...
            else
            {
                try
                {
                    ...
                    dbS.CapNhat(this.txtMaHDmua.Text, this.txtMasach.Text, int.Parse(this.txtiatien.Text), int.Parse(this.txtsoluong.Text), ref err);
                    LoadData();
                    // Thông báo
        ...
        private void txtMaHDmua_TextChanged(object sender, EventArgs e)
        {
